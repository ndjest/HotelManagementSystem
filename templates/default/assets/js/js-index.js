...
function mySelectUpdate(prop_type){
	setTimeout(function (){
		jQuery('.mySelectBoxClass').trigger('update');
	}, 200);
    jQuery('#property_type_id').val(prop_type);
    jQuery('#hotel_sel_loc_id').prop('selectedIndex', 0);
    jQuery('#hotel_sel_id').children('option:not(:first)').remove();
}
