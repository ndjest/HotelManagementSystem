if(hsJsHost != ''){
	...
	if(hsJsKey != '' && hsJsHost != ''){
		...
		var filePath = 'widgets/hotels/ipanel-top/index.php?host='+encoded_host+'&key='+encoded_key+'&hids='+encoded_ids;
		
		// setup the iframe target
		var iframe='<iframe id="frame" name="widget" src="#" width="800px" height="180px" marginheight="0" marginwidth="0" frameborder="no" scrolling="no"></iframe>';
